...
import JetApplicationMark from '@/CommonComponents/ApplicationMark.vue';
import JetBanner from '@/CommonComponents/Banner.vue';
import JetDropdown from '@/CommonComponents/Dropdown.vue';
import JetDropdownLink from '@/CommonComponents/DropdownLink.vue';
import JetNavLink from '@/CommonComponents/NavLink.vue';
import JetResponsiveNavLink from '@/CommonComponents/ResponsiveNavLink.vue';
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('students')" :active="route().current('students')">
                                    Students
                                </JetNavLink>
                            </div>
                        </div>
